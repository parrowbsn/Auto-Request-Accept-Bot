...
async def start(client: pr0fess0r_99, message: Message):
    ...
    button=[[
      InlineKeyboardButton("𝚄𝙿𝙳𝙰𝚃𝙴𝚉", url="https://t.me/Sparrow_Bots"),
      InlineKeyboardButton("𝚂𝚄𝙿𝙿𝙾𝚁𝚃", url="https://t.me/Harshu_Raven")
      ],[
      InlineKeyboardButton("𝙹𝙾𝙸𝙽", url=f"https://t.me/Raven_legion")
      ]]
